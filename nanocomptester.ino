...
const unsigned char VERSION_str[] MEM2_TEXT = "Tester 1.08.4";
...
void setup()
{
  ...
  pinMode(TestKeyPin, INPUT);
    ...
    lcd_string("ComponentTester");
    lcd_set_cursor(1, 0);
    lcd_string("Input A0 A1 A2");
  #endif
  ...
  #if defined(NOK5110) || defined(OLED096)
    lcd_string("Electronic Compnent");
    lcd_set_cursor(1, 0);
    lcd_string("Tester");
    lcd_set_cursor(2, 0);
    lcd_string("Werner Muller");
    lcd_set_cursor(3, 0);
    lcd_string("V51JP");
    lcd_set_cursor(4, 0);
    lcd_string("081 756 1880");
  #endif
